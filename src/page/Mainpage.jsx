            ...
            <div className={module.follow}>
                ...
                <div className={module.friends}>
                    <div className={module.akk1}>
                        ...
                        <div className={module.nik}>mobile Top <br /><span>Aalybek</span></div>
                    </div>
                ...
                <div className={module.friends}>
                    <div className={module.akk1}>
                        ...
                        <div className={module.nik}>Berserk top <br /><span>Sanjarbek</span></div>
                    </div>
                    <a className={module.change} href='#'>подписаться</a>
                </div>
                ...
                <div className={module.friends}>
                    <div className={module.akk1}>
                        ...
                        <div className={module.nik}>lol govno <br /><span>Erzanbek</span></div>
                    </div>
                    <a className={module.change} href='#'>подписаться</a>
                </div>
                ...
                <div className={module.friends}>
                    <div className={module.akk1}>
                        ...
                        <div className={module.nik}>Love Akane <br /><span>Yriskeldibek</span></div>
                    </div>
                    <a className={module.change} href='#'>подписаться</a>
                </div>
